  ...
  "rounded-xl transition-all duration-200",
  {
    variants: {
      variant: {
        ...
        elevated: "bg-card text-card-foreground shadow-card hover:shadow-elevated",
        health: "bg-gradient-to-br from-accent to-background border-2 border-primary/20 shadow-card",
